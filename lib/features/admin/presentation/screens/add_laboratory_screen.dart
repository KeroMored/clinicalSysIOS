...
class _AddLaboratoryScreenState extends State<AddLaboratoryScreen> {
              ...
              content: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final tests = AvailableLabTests.getTestsByCategory(category);
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('إضافة معمل تحاليل'),
          centerTitle: true,
          backgroundColor: Colors.green,
          ...
          child: ListView(
            ...
            children: [
              ...
              Card(
                ...
                subtitle: const Text('هل يقدم المعمل خدمة التحاليل في المنزل؟'),
                      ...
                      child: InkWell(
                        onTap: () async {
                          final time = await showTimePicker(
                            context: context,
                            initialTime: fromTime ?? const TimeOfDay(hour: 8, minute: 0),
                          );
                          if (time != null) {
                    ...
                    Expanded(
                      child: InkWell(
                        onTap: () async {
                          final time = await showTimePicker(
                            context: context,
                            initialTime: toTime ?? const TimeOfDay(hour: 20, minute: 0),
                          );
                          if (time != null) {
