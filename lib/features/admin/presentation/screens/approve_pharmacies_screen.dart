...
class ApprovePharmaciesScreen extends StatefulWidget {
  ...
  @override
  State<ApprovePharmaciesScreen> createState() =>
      _ApprovePharmaciesScreenState();
}

class _ApprovePharmaciesScreenState extends State<ApprovePharmaciesScreen> {
  String _selectedFilter = 'pending'; // pending, rejected, all

  @override
  void initState() {
    super.initState();
    context.read<AdminCubit>().loadPharmacyRequestsByStatus(_selectedFilter);
  }
  ...
  void _onFilterChanged(String filter) {
    ...
    context.read<AdminCubit>().loadPharmacyRequestsByStatus(filter);
  }
      ...
      appBar: GradientAppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              context.read<AdminCubit>().loadPharmacyRequestsByStatus(
                _selectedFilter,
              );
            },
          ),
            ...
            Expanded(
              child: BlocConsumer<AdminCubit, AdminState>(
                ...
                builder: (context, state) {
                  ...
                  if (state is PharmacyRequestsLoaded) {
                    ...
                    return RefreshIndicator(
                      onRefresh: () => context
                          .read<AdminCubit>()
                          .loadPharmacyRequestsByStatus(_selectedFilter),
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => BlocProvider.value(
                                    ...
                                    child: PharmacyRequestDetailsScreen(
                                      request: request,
                                    ),
                                  ),
                                ),
