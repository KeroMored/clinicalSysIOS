  ...
  Future<String?> _uploadImage(XFile image, String folder) async {
    try {
      final ref = FirebaseStorage.instance
          .ref()
          .child('rehabilitation/$folder/${DateTime.now().millisecondsSinceEpoch}.jpg');
  ...
  Future<void> _getCurrentLocation() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('تم تحديد الموقع: ${position.latitude}, ${position.longitude}'),
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'البريد الإلكتروني * (للمصادقة والتحكم)',
                  ...
                  children: RehabilitationTypes.allTypes.map((type) {
                    ...
                    return FilterChip(
                      label: Text(
                        type,
                        style: TextStyle(
                          color: isSelected ? const Color(0xFFA855F7) : const Color(0xFF0F172A),
                      ...
                      selectedColor: const Color(0xFFA855F7).withOpacity(0.1),
                              ...
                              children: [
                                Expanded(
                                  child: OutlinedButton.icon(
                                    onPressed: () =>
                                        _selectTime(context, true, englishDay),
                                ...
                                Expanded(
                                  child: OutlinedButton.icon(
                                    onPressed: () =>
                                        _selectTime(context, false, englishDay),
                                    icon: const Icon(Icons.access_time),
                                    label: Text(
