  ...
  Future<List<String>> _uploadImages() async {
    ...
    try {
      for (int i = 0; i < _selectedImages.length; i++) {
        ...
        final fileName = 'pharmacy_${DateTime.now().millisecondsSinceEpoch}_$i.jpg';
  ...
  void _submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      final request = PharmacyRequestModel(
        ...
        minimumOrderForDelivery: _minimumOrderForDelivery,
        services: [],
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              const Icon(Icons.location_on, color: Color(0xFF06B6D4)),
                              const SizedBox(width: 8),
                              const Text(
                                'تحديد الموقع',
                                style: TextStyle(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_hasHomeDelivery) ...[
                            ...
                            _buildTextField(
                              controller: TextEditingController(
                                text: _minimumOrderForDelivery?.toString() ?? '',
                              ),
