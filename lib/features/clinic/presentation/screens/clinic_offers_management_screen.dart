...
import '../../data/models/clinic_offer_model.dart';
import 'add_clinic_offer_screen.dart';
import 'package:clinicalsystem/core/widgets/app_loading_indicator.dart';

class ClinicOffersManagementScreen extends StatefulWidget {
  final ClinicModel clinic;

  const ClinicOffersManagementScreen({super.key, required this.clinic});

  @override
  State<ClinicOffersManagementScreen> createState() =>
      _ClinicOffersManagementScreenState();
}

class _ClinicOffersManagementScreenState
    extends State<ClinicOffersManagementScreen> {
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final offer = ClinicOfferModel.fromJson({
                  'id': offers[index].id,
                  ...offerData,
                });
          ...
          child: FloatingActionButton.extended(
            onPressed: () async {
              final result = await Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      AddClinicOfferScreen(clinic: widget.clinic),
                ),
              );
  ...
  Widget _buildOfferCard(ClinicOfferModel offer) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(16),
  ...
  Future<void> _toggleOfferStatus(ClinicOfferModel offer) async {
    try {
  ...
  Future<void> _deleteOffer(ClinicOfferModel offer) async {
