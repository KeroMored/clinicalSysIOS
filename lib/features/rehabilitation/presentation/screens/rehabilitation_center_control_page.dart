...
class RehabilitationCenterControlPage extends StatefulWidget {
  ...
  const RehabilitationCenterControlPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(_center!.centerName,style: TextStyle(color: Colors.white),),
        backgroundColor: Colors.purple,
        foregroundColor: Colors.white,
      ),
      body: Padding(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfoRow(
                          Icons.location_on, 'العنوان', _center!.address),
                      const SizedBox(height: 8),
                      _buildInfoRow(Icons.email, 'البريد الإلكتروني',
                          _center!.authEmails.isNotEmpty ? _center!.authEmails.first : 'غير متوفر'),
                      const SizedBox(height: 16),
                      Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: [
                          ..._center!.serviceTypes.map((service) => Chip(
                                label: Text(service,
                        ...
                        children: [
                          Expanded(
                            child: _buildStatCard(
                              icon: Icons.star,
                              value: _center!.averageRating.toStringAsFixed(1),
                              label: 'التقييم',
                              color: Colors.amber,
                            ),
                          ),
